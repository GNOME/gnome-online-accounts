...
G_DEFINE_TYPE_WITH_CODE (GoaNextcloudProvider, goa_nextcloud_provider, GOA_TYPE_WEBDAV_PROVIDER,
...
{
  // NOTE: for historical reasons, this provider's type name is "owncloud"
...
{
  return g_themed_icon_new_with_default_fallbacks ("goa-account-nextcloud");
}
              ...
              GError             **error)
{
  ...
  return GOA_PROVIDER_CLASS (goa_nextcloud_provider_parent_class)->build_object (provider,
                                                                                object,
                                                                                key_file,
                                                                                group,
                                                                                connection,
