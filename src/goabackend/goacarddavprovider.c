...
/*
 * Copyright © 2020 Kévin Commaille
 *
...
struct _GoaCarddavProvider
{
  GoaProvider parent_instance;
};

G_DEFINE_TYPE_WITH_CODE (GoaCarddavProvider, goa_carddav_provider, GOA_TYPE_PROVIDER,
...
{
  return GOA_CARDDAV_NAME;
}

static gchar *
get_provider_name (GoaProvider *provider, GoaObject *object)
{
  return g_strdup(_("CardDAV"));
}

static GoaProviderGroup
get_provider_group (GoaProvider *provider)
{
  return GOA_PROVIDER_GROUP_CONTACTS;
}

static GoaProviderFeatures
get_provider_features (GoaProvider *provider)
{
  return GOA_PROVIDER_FEATURE_CONTACTS;
}

static GIcon *
get_provider_icon (GoaProvider *provider, GoaObject *object)
{
  return g_themed_icon_new_with_default_fallbacks ("x-office-address-book-symbolic");
}
                 ...
                 GError        **error)
{
  ...
  g_return_val_if_fail (GOA_IS_CARDDAV_PROVIDER (provider), FALSE);
...
static void
goa_carddav_provider_init (GoaCarddavProvider *self)
{
}

static void
goa_carddav_provider_class_init (GoaCarddavProviderClass *klass)
{
